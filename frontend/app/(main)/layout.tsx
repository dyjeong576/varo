...
export default function MainLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col min-h-[100dvh]">
      {/* Top Navigation - Hidden on notifications page to use its specific header */}
      {!isNotificationsPage && (
        <header className="fixed top-0 left-0 right-0 h-14 bg-white border-b border-gray-100 z-[100] px-4 flex items-center justify-between shadow-sm">
          <div className="flex items-center gap-2">
            <HistoryDrawer />
            <Link href="/" className="flex items-center active:scale-95 transition-transform duration-150 ml-1">
              <Image 
                src="/logo/verifi_logo.png" 
                alt="Verifi Logo" 
                width={87} 
                height={32} 
          ...
          <div className="flex items-center">
            ...
            >
              ...
              {/* 작은 파란색 점을 추가하여 더 명확하게 알림 버튼임을 표시 */}
