...
INSERT INTO "source_domain_registry" (
    ...
    ('sdr-kr-sns-001', 'youtube.com', 'KR', NULL, 'social_platform', 'familiar_social', 300, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('sdr-kr-sns-002', 'youtu.be', 'KR', NULL, 'social_platform', 'familiar_social', 310, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('sdr-kr-sns-003', 'instagram.com', 'KR', NULL, 'social_platform', 'familiar_social', 320, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('sdr-kr-sns-004', 'threads.net', 'KR', NULL, 'social_platform', 'familiar_social', 330, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('sdr-kr-sns-005', 'facebook.com', 'KR', NULL, 'social_platform', 'familiar_social', 340, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('sdr-kr-sns-006', 'x.com', 'KR', NULL, 'social_platform', 'familiar_social', 350, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('sdr-kr-sns-007', 'twitter.com', 'KR', NULL, 'social_platform', 'familiar_social', 360, true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
