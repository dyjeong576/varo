import { AnswersTavilyClient } from "./answers-tavily.client";
import { SearchCandidate } from "../answers.types";
...
describe("AnswersTavilyClient", () => {
  ...
  it("extract 응답을 normalized content와 snippet으로 변환한다", async () => {
    ...
    const client = new AnswersTavilyClient();
